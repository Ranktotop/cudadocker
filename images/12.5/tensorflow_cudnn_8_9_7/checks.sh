...
dpkg -s libcudnn9-cuda-12 2>/dev/null | grep -q "Version: 8.9.7" \
  && echo "[OK] cuDNN 8.9.7 korrekt gepinnt" \
  || { echo "[FAIL] cuDNN nicht korrekt gepinnt (erwartet libcudnn9-cuda-12 8.9.7.*)"; dpkg -s libcudnn9-cuda-12 || true; exit 1; }
